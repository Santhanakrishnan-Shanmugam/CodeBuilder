...
function App() {
  ...
  const fetchFiles = async () => {
    try {
      ...
      const response = await axios.post("https://codebuilder-447025990763.asia-south1.run.app/get-file-content",payload);
  ...
  const handleDownload = async () => {
    try {
      const response = await axios.get("https://codebuilder-447025990763.asia-south1.run.app/download-project", {
        responseType: "blob",
      });
